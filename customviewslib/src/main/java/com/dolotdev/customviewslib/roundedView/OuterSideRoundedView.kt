...
class OuterSideRoundedView @JvmOverloads constructor(
    ...
    init {
        val a = context.theme.obtainStyledAttributes(
            attrs,
            R.styleable.OuterSideRoundedView,
            defStyleAttr,
            0
        )
        val roundedCorners = a.getInteger(R.styleable.OuterSideRoundedView_side, 0)
        initRoundedCorners(roundedCorners)

        cornerRadius = a.getDimensionPixelSize(R.styleable.OuterSideRoundedView_radius, 0)

        bgColor = a.getColor(R.styleable.OuterSideRoundedView_backgroundColor, Color.WHITE)
        a.recycle()
    }
